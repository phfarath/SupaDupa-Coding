...
export async function configCommand(action?: string, key?: string, value?: any) {
  try {
...
async function handleInit(configManager: ConfigManager) {
...
async function handleShow(configManager: ConfigManager, key: string | undefined) {
...
async function handleSet(configManager: ConfigManager, key: string | undefined, value: any) {
...
async function handleReset(configManager: ConfigManager) {
