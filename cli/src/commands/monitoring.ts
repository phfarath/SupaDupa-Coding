...
export async function metricsCommand(action: string = 'collect', options: MetricsCommandOptions = {}) {
  try {
    switch (action) {
      case 'collect':
...
async function collectMetrics(options: MetricsCommandOptions) {
...
async function showMetrics(options: MetricsCommandOptions) {
...
export async function logsCommand(action: string = 'query', options: MetricsCommandOptions = {}) {
  try {
    switch (action) {
      case 'query':
...
async function queryLogs(options: MetricsCommandOptions) {
...
async function exportLogs(options: MetricsCommandOptions) {
  const format = options.format || 'json';
...
export async function alertCommand(action: string = 'configure', alertName?: string, options: MetricsCommandOptions = {}) {
  try {
    switch (action) {
      case 'configure':
...
async function configureAlert(alertName: string | undefined, options: MetricsCommandOptions) {
  if (!alertName) {
...
async function listAlerts(options: MetricsCommandOptions) {
  ...
  try {
    ...
    for (const file of files) {
      ...
      const alert: AlertConfig = JSON.parse(data);
